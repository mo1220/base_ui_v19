...
@Component({
  selector: 'input-mask',
  templateUrl: 'input-mask.template.html',
  host: {
    // class: 'p-element',
    '[class.input-wrapper-filled]': 'filled',
    '[class.input-wrapper-focus]': 'focused',
    '[class.input-mask-clearable]': 'showClear && !disabled'
  },
  providers: [INPUTMASK_VALUE_ACCESSOR],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./input-mask.style.scss']
})
