import { Directive, ElementRef, HostListener, Input, forwardRef, Output, EventEmitter, Inject, PLATFORM_ID, Provider } from '@angular/core';
import { DOCUMENT } from '@angular/common';
// import { DomHandler } from 'primeng/dom';
import { Validator, AbstractControl, NG_VALIDATORS } from '@angular/forms';
import { KeyFilterPattern } from './key-filter.model';
...
export class KeyFilter implements Validator {
  ...
  @Input('keyFilter') set pattern(_pattern: RegExp | KeyFilterPattern | null | undefined) {
    this._pattern = _pattern;

    console.log(_pattern instanceof RegExp, _pattern);
