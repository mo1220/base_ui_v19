...
import { InputNumberInputEvent } from './input-number.interface';
import { Nullable } from "../input-mask/input-mask.component";
...
export class InputNumber implements OnInit, AfterContentInit, OnChanges, ControlValueAccessor {
   ...
   * @group Props
   */
  @Input() styleClass: string | undefined; // class 명
  /**
  ...
  incrementButtonIconTemplate: Nullable<TemplateRef<any>> | any;
  decrementButtonIconTemplate: Nullable<TemplateRef<any>> | any;
