import {
  ...
  Component,
  ViewEncapsulation,
  Inject, Renderer2, ChangeDetectorRef, forwardRef, ChangeDetectionStrategy
} from '@angular/core';
...
export class KnobComponent {
   ...
   * @group Props
   */
  @Input() valueColor: string = 'var(--bs-primary, Black)';
  /**
