...
describe('LocalStorageService', () => {
  ...
  it('should load nested initial store', () => {
  ...
  it('should load initial store with camel case property', () => {
  ...
  it('should load nested initial store with camel case properties', () => {
